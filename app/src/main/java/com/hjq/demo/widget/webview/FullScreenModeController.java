 ...
 *    desc   : 全屏模式控制器
 */
public final class FullScreenModeController {
    ...
    public void enterFullScreenMode(@Nullable Activity activity, @Nullable View customView, @Nullable CustomViewCallback callback) {
        if (isFullScreenMode()) {
     ...
     */
    @SuppressWarnings("deprecation")
    public void exitFullScreenMode(@Nullable Activity activity) {
        if (!isFullScreenMode()) {
            return;
        }
